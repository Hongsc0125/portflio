          ...
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold">(주) 메타빌드</h3>
                  <p className="text-sm text-gray-500">2024.01 - (재직 중)</p>
                </div>
              </div>
            </div>
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg">
                    ...
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">위기청소년 통합지원 시스템 운영</p>
                      </div>
                    </div>
                    <div className="mt-5 space-y-2">
                      <div className="flex items-center gap-4">
                        <div className="w-1 h-4 bg-black"></div>
                        <p className="font-bold text-gray-800">통계시스템 개선</p>
                        <span className="text-gray-300">|</span>
                        <p className="text-sm text-gray-500">2025년 상반기</p>
                      </div>
                    ...
                    <div className="mt-5 space-y-2">
                      <div className="flex items-center gap-4">
                        <div className="w-1 h-4 bg-black"></div>
                        <p className="font-bold text-gray-800">인증시스템 개발</p>
                        <span className="text-gray-300">|</span>
                        <p className="text-sm text-gray-500">2024년 하반기</p>
                      </div>
                      <p className="text-sm text-gray-600 flex items-center gap-2">
                        <span className="w-1.5 h-1.5 bg-gray-400 rounded-full"></span>
                    ...
                    <div className="mt-5 space-y-2">
                      <div className="flex items-center gap-4">
                        <div className="w-1 h-4 bg-black"></div>
                        <p className="font-bold text-gray-800">청소년 증명서 출력 개선</p>
                        <span className="text-gray-300">|</span>
                        <p className="text-sm text-gray-500">2024년 중반기</p>
                      </div>
                      <p className="text-sm text-gray-600 flex items-center gap-2">
                        <span className="w-1.5 h-1.5 bg-gray-400 rounded-full"></span>
                    ...
                    <div className="mt-5 space-y-2">
                      <div className="flex items-center gap-4">
                        <div className="w-1 h-4 bg-black"></div>
                        <p className="font-bold text-gray-800">시스템 운영 및 유지보수</p>
                        <span className="text-gray-300">|</span>
                        <p className="text-sm text-gray-500">2024년 ~ 2025년 상반기</p>
                      </div>
                      <p className="text-sm text-gray-600 flex items-center gap-2">
                        <span className="w-1.5 h-1.5 bg-gray-400 rounded-full"></span>
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div className="bg-gray-50 p-3 rounded-lg">
                    ...
                    <div className="mt-5 space-y-2">
                      <div className="flex items-center gap-4">
                        <div className="w-1 h-4 bg-black"></div>
                        <p className="font-bold text-gray-800">ERP 차세대 구축에 대응하는 EAI 구축</p>
                        <span className="text-gray-300">|</span>
                        <p className="text-sm text-gray-500">2025년 중반기 ~ </p>
                      </div>
                      <p className="text-sm text-gray-600 flex items-center gap-2">
                        <span className="w-1.5 h-1.5 bg-gray-400 rounded-full"></span>
